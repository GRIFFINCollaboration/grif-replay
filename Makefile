GRIF_OBJECTS = config.o grif-replay.o midas-format.o grif-format.o histogram.o\
          web_server.o grif-reorder.o user_sort_griffin.o griffin_sort.o \
          test_config.o odb.o

DRAGON_OBJECTS = config.o dragon-replay.o midas-format.o histogram.o \
          web_server.o dragon-reorder.o user_sort_dragon.o dragon_sort.o \
          test_config.o dragon-format.o odb.o
...
griffin_sort.o:   griffin_sort.c griffin_sort.h config.h grif-format.h histogram.h
dragon_sort.o:    dragon_sort.c dragon_sort.h config.h dragon-format.h histogram.h
